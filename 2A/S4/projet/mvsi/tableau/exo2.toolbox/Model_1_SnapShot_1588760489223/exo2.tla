...
*)
\* BEGIN TRANSLATION - the hash of the PCal code: PCal-70bec887aebd0e00dd297901b6152d3e
...
\* END TRANSLATION - the hash of the generated TLA code (remove to silence divergence warnings): TLA-f05700e1baa5af57a48457f8d77191fa

RECURSIVE ArrayOrderedFromIndex(_,_)

ArrayOrderedFromIndex( A, index) == IF index = Len(A) THEN FALSE
                              ELSE A[index] <= A[index+1] /\ ArrayOrderedFromIndex(A,index+1)

partial_correctness == pc = "Done" => ArrayOrderedFromIndex(array,0) 



=============================================================================
\* Modification History
\* Last modified Wed May 06 12:21:23 CEST 2020 by Antoine
