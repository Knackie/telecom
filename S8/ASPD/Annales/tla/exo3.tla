...
election(i) ==
    ...
    /\ nb[i]=sn[i]
        ...
        /\ UNCHANGED,time <<nb,sn,bm,bt,ba,msg,ack,tr,cnt,con>>
-----------------------------------------------------
...
sending_msg(x,y) ==
    ...
    /\ nb[x]=sn[x] \cup {y}
        /\ msg' = msg \cup {<<x,y>>}
    /\ bm' = bm \cup {x}
        /\ UNCHANGED,time <<nb,sn,bt,ba,root,ack,tr,cnt,con>>
-----------------------------------------------------
sending_ack(x,y) ==
    /\ <<x,y>> \in msg
    /\ x \notin ba[y]
    ...
    /\ ack' = ack \cup {<<x,y>>}
        /\ UNCHANGED,time <<nb,sn,bm,bt,root,msg,tr,cnt,con>>
-----------------------------------------------------
...
progress(x,y) ==
    ...
    /\ bt' = bt \cup {x} 
    /\ time' = time+1
        /\ UNCHANGED,time <<nb,sn,bm,ba,root,msg,ack,cnt>>
...
rcv_cnf(x,y) == 
    ...
    /\ x \notin sn[y]
        ...
        /\ UNCHANGED,time <<nb,bm,bt,ba,root,msg,ack,tr,cnt,con>>
...
decontention(x,y) ==
    ...
    /\  <<y,x>> \in cnt
        ...
        /\ bm'= bm - {x,y}
        /\ cnt'= {}
        /\ UNCHANGED,time <<nb,sn,bt,ba,root,ack,tr,con>>
...
contention(x,y) ==
    ...
    /\ y \in bm
        /\ cnt'=cnt\cup {<<x,y>>}
    /\ con'= 1
        /\ UNCHANGED,time <<nb,sn,bm,bt,ba,root,msg,ack,tr>>
...
Init == 
    ...
    /\ tr ={}
    /\ con = 0
    /\ time = time + 1 IF time < TIMEOUT ELSE time
