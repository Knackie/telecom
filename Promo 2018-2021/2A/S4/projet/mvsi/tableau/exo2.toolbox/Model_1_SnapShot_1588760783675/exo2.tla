...
--fair algorithm projet_ex2{
    variables c; d; position; swap; array;
    {
        ...
        l2: print c;
        l55: array :=arrayCP;
        l3: while(c<Len(array)-1) {
            l4: position:=c;
            l5: d:=c+1;
            l6: while(d<Len(array)){
...
*)
\* BEGIN TRANSLATION - the hash of the PCal code: PCal-78015081d6474241410797b06ed08598
...
\* END TRANSLATION - the hash of the generated TLA code (remove to silence divergence warnings): TLA-96ff0d4be3a2727e91691ea14fdf30e2
...
\* Last modified Wed May 06 12:26:18 CEST 2020 by Antoine
